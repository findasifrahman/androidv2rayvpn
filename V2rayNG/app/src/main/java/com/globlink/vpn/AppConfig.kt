...
object AppConfig {
    ...
    const val ANG_PACKAGE = "com.globlink.vpn"
    ...
    /** Broadcast actions. */
    const val BROADCAST_ACTION_SERVICE = "com.globlink.vpn.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.globlink.vpn.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.globlink.vpn.action.widget.click"
