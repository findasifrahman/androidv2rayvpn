package com.globlink.vpn.handler
...
import com.globlink.vpn.AppConfig.DEFAULT_NETWORK
import com.globlink.vpn.AppConfig.DNS_ALIDNS_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_ALIDNS_DOMAIN
import com.globlink.vpn.AppConfig.DNS_CLOUDFLARE_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_CLOUDFLARE_DOMAIN
import com.globlink.vpn.AppConfig.DNS_DNSPOD_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_DNSPOD_DOMAIN
import com.globlink.vpn.AppConfig.DNS_GOOGLE_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_GOOGLE_DOMAIN
import com.globlink.vpn.AppConfig.DNS_QUAD9_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_QUAD9_DOMAIN
import com.globlink.vpn.AppConfig.DNS_YANDEX_ADDRESSES
import com.globlink.vpn.AppConfig.DNS_YANDEX_DOMAIN
import com.globlink.vpn.AppConfig.GEOIP_CN
import com.globlink.vpn.AppConfig.GEOSITE_CN
import com.globlink.vpn.AppConfig.GEOSITE_PRIVATE
import com.globlink.vpn.AppConfig.GOOGLEAPIS_CN_DOMAIN
import com.globlink.vpn.AppConfig.GOOGLEAPIS_COM_DOMAIN
import com.globlink.vpn.AppConfig.HEADER_TYPE_HTTP
import com.globlink.vpn.AppConfig.LOOPBACK
import com.globlink.vpn.AppConfig.PROTOCOL_FREEDOM
import com.globlink.vpn.AppConfig.TAG_BLOCKED
import com.globlink.vpn.AppConfig.TAG_DIRECT
import com.globlink.vpn.AppConfig.TAG_FRAGMENT
import com.globlink.vpn.AppConfig.TAG_PROXY
import com.globlink.vpn.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.globlink.vpn.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.globlink.vpn.dto.ConfigResult
...
import com.globlink.vpn.dto.V2rayConfig.RoutingBean.RulesBean
import com.globlink.vpn.extension.isNotNullEmpty
import com.globlink.vpn.fmt.HttpFmt
import com.globlink.vpn.fmt.Hysteria2Fmt
import com.globlink.vpn.fmt.ShadowsocksFmt
import com.globlink.vpn.fmt.SocksFmt
import com.globlink.vpn.fmt.TrojanFmt
import com.globlink.vpn.fmt.VlessFmt
import com.globlink.vpn.fmt.VmessFmt
import com.globlink.vpn.fmt.WireguardFmt
