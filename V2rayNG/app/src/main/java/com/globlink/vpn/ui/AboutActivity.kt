...
class AboutActivity : BaseActivity() {
    ...
    ////// permission launcher by asi
    // This variable holds the URI while we wait for the permission result.


    // Register the permission launcher. The callback will be triggered with the result.
