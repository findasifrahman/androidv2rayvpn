...
//            }
            ...
            holder.itemMainBinding.tvName.text = "GlobLink.Server." + (position+1).toString()//profile.remarks
            ...
            holder.itemMainBinding.tvStatistics.text = "Server-Hongkong"//strState
